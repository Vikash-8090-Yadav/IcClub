...
import { idlFactory } from './mytodo_backend.did.js';
export { idlFactory } from './mytodo_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MYTODO_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mytodo_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mytodo_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mytodo_backend.did.js")._SERVICE>}
 */
export const mytodo_backend = createActor(canisterId);
