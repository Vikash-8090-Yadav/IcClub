...
import { idlFactory } from './mytodo_frontend.did.js';
export { idlFactory } from './mytodo_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MYTODO_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mytodo_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mytodo_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mytodo_frontend.did.js")._SERVICE>}
 */
export const mytodo_frontend = createActor(canisterId);
